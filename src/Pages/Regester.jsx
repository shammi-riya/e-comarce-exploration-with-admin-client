...
const handlesubmit = (e) => {
    ...
    const displayName = e.target.fristname.value;
    ...
    return (
        <div>
             <div className="min-w-screen h-[84vh]  mt-40 mb-24 flex items-center justify-center px-5 ">
    <div className="bg-gray-100 text-gray-500    shadow-xl w-full overflow-hidden" >
        <div className="md:flex w-full">
            <div className="hidden md:block w-1/2 bg-[#21476b] py-10 px-10">
                    ...
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            ...
                            <div className="flex">
                                ...
                                required
                                name="email"
                                 className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-[#21476b]" placeholder="johnsmith@example.com"/>
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            ...
                            <div className="flex">
                                ...
                                required
                                defaultValue="+88"
                                className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-[#21476b]" placeholder="+88*************"/>
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-12">
                            ...
                            <div className="flex">
                                ...
                                name="password"
                                required
                                className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-[#21476b]" placeholder="************"/>
                            </div>
                        </div>
                    </div>

                    <h5 className="text-[#21476b] pb-4 font-semiboldbold text-xl">You Have Alreafy An Account  ? Please <Link to='/login'><span className="font-bold">Login</span></Link></h5>



                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            <button className="block w-full max-w-xs mx-auto bg-[#21476b] hover:bg-[#43719d] focus:border-[#21476b] text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
                        </div>
                    </div>
                </div>
            </form>
