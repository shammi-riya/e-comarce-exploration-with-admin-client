...
const Featurseproducts = () => {
    ...
    return (
        <div className="max-w-7xl lg:px-0 px-10 mx-auto my-20">
            <div className="flex justify-between items-center my-2">
            <h3 className="text-4xl ">Our Featue Products</h3>
            <Link to='/products'><span><Button>View More</Button></span></Link>
            </div>
            {
                <div className='grid py-28 lg:grid-cols-4 gap-5 md:grid-cols-3 grid-cols-1 max-w-7xl mx-auto lg:px-0  px-7'>
                    {
                        productData.slice(0,8).map(product => <div key={product.name}
...
export default Featurseproducts;