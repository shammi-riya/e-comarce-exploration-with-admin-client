...
const Login = () => {
 const {sighinInUser} = useContext(AuthContext);
 ...
 const handleSubmit = (e) => {
    ...
    return (
        <div>
            <div className="min-w-screen h-[84vh]  mt-40 mb-20 flex items-center justify-center px-5 ">
                    ...
                    <div className="md:flex w-full">
                        ...
                        <form onSubmit={handleSubmit}
                            ...
                            <div className="text-center mb-10">
                                <h1 className="font-bold text-3xl text-gray-900">LOGIN NOW</h1>
                                <p>Enter your information to Login this website</p>
                            </div>
                            <div>
                                ...
                                <h5 className="text-[#21476b] pb-4 font-semiboldbold text-xl">You Have New To Website ? Please <Link to='/regester'><span className="font-bold">Regester</span></Link></h5>

                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <button className="block w-full max-w-xs mx-auto bg-[#21476b] hover:bg-[#43719d] focus:border-[#21476b] text-white rounded-lg px-3 py-3 font-semibold">LOGIN NOW</button>
                                    </div>
                                </div>
                            </div>
                        </form>
